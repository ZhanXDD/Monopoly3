...
public class RailRoadCellTest extends TestCase {
	...
	public void testPlayerAction() {
		RailRoadCell cell =
			(RailRoadCell) gameMaster.getGameBoard().queryCell(rail);
		int cellIndex = gameMaster.getGameBoard().queryCellIndex(rail);
	...
	public void testRent() {
		RailRoadCell rr1 =
			(RailRoadCell) gameMaster.getGameBoard().queryCell(rail);
		int cellIndex1 = gameMaster.getGameBoard().queryCellIndex(rail);
