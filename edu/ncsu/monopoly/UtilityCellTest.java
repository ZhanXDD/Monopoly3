...
public class UtilityCellTest extends TestCase {
	String util1 = "Utility 1";
	String util2 = "Utility 2";
    ...
    public void testMonopoly() {
        int u1CellIndex = gameMaster.getGameBoard().queryCellIndex(util1);
        gameMaster.movePlayer(0, u1CellIndex);
        gameMaster.getPlayer(0).purchase();
        int u2CellIndex = gameMaster.getGameBoard().queryCellIndex(util2);
	...
	public void testPlayerAction() {
		UtilityCell cell =
			(UtilityCell) gameMaster.getGameBoard().queryCell(util1);
		int cellIndex = gameMaster.getGameBoard().queryCellIndex(util1);
	...
	public void testRent() {
		UtilityCell u1 =
			(UtilityCell) gameMaster.getGameBoard().queryCell(util1);
		int cellIndex1 = gameMaster.getGameBoard().queryCellIndex(util1);
		gameMaster.movePlayer(0, cellIndex1);
		gameMaster.getPlayer(0).purchase();
		assertEquals(40, u1.getRent(10));

		UtilityCell u2 =
			(UtilityCell) gameMaster.getGameBoard().queryCell(util2);
		int cellIndex2 = gameMaster.getGameBoard().queryCellIndex(util2);
